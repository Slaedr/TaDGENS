...
void writeScalarsVectorToVtu_PointData(std::string fname, const UMesh2dh& m, const amat::Array2d<double>& x, std::string scaname[], const amat::Array2d<double>& y, std::string vecname)
{
	std::cout << "aoutput: Writing vtu output to " << fname << "\n";
	std::ofstream out(fname);
